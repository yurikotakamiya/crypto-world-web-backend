exports.up = function(knex) {
  return knex.schema.createTable('users', tbl => {
    tbl.bigint('user_id').unsigned().primary()
  ...
  .createTable('orders', tbl => {
    ...
    tbl.timestamp('create_time').defaultTo(knex.raw('CURRENT_TIMESTAMP'))
    tbl.timestamp('update_time').defaultTo(knex.raw('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'))
