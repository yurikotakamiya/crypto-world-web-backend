exports.up = function(knex) {
  ...
  .createTable('monitors', tbl => {
    tbl.tinyint('monitor_id').unsigned().notNullable().primary()
    tbl.string('monitor_name', 64)
    tbl.text('description').notNullable()
  })
  .createTable('monitor_configs', tbl => {
    tbl.integer('user_id')
      .unsigned()    
      .notNullable()
      .references('user_id')
...
exports.down = function(knex) {
    ...
    .dropTableIfExists('monitor_configs')
